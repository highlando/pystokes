...
tol = 2**(-12)
HL = [16,32,64,128,256,512,512]

plu.merge_json_dicts(    'json/Omeg8Tol%1.2e' % tol + 'NTs%d' % HL[0] + 'to%d' % HL[0] + 'Mesh40HalfExpEulSmaMin.json',
					     'json/Omeg8Tol%1.2e' % tol + 'NTs%d' % HL[1] + 'to%d' % HL[1] + 'Mesh40HalfExpEulSmaMin.json')
...
plu.merge_json_dicts('json/MrgdOmeg8Tol%1.2e' % tol + 'NTs%d' % HL[0] + 'to%d' % HL[3] + 'Mesh40HalfExpEulSmaMin.json',
